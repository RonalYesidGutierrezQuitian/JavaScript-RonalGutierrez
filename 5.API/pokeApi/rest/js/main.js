...
// Función para realizar la solicitud REST y obtener los datos del Pokémon
const fetchPokemon = (pokemon) => {
    // URL de la API RESTful para obtener datos del Pokémon
    const url = `https://pokeapi.co/api/v2/pokemon/${pokemon}`;
    
    // Realizar la solicitud REST utilizando el método fetch
    fetch(url)
        .then(response => {
